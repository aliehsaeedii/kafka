...
public final class MultiVersionedRangeQuery<K, V> implements Query<KeyValueIterator<K, VersionedRecord<V>>> {
    ...
    */
    public static <K, V> MultiVersionedRangeQuery<K, V> withKeyRange(final K lower, final K upper) {
        return new MultiVersionedRangeQuery<>(Optional.of(lower), Optional.of(upper), Optional.empty(), Optional.empty());
    }
    ...
    */
    public static <K, V> MultiVersionedRangeQuery<K, V> withLowerKeyBound(final K lower) {
        return new MultiVersionedRangeQuery<>(Optional.of(lower), Optional.empty(), Optional.empty(), Optional.empty());
    }
    ...
    */
    public static <K, V> MultiVersionedRangeQuery<K, V> withUpperKeyBound(final K upper) {
        return new MultiVersionedRangeQuery<>(Optional.empty(), Optional.of(upper), Optional.empty(), Optional.empty());
    }
    ...
    */
    public static <K, V> MultiVersionedRangeQuery<K, V> allKeys() {
        return new MultiVersionedRangeQuery<>(Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty());
    }
    ...
    */
    public MultiVersionedRangeQuery<K, V> fromTime(final Instant fromTime) {
        if (fromTime == null) {
            return new MultiVersionedRangeQuery<>(lower, upper, Optional.empty(), toTime);
        }
        return new MultiVersionedRangeQuery<>(lower, upper, Optional.of(fromTime), toTime);
    }
    ...
    */
    public MultiVersionedRangeQuery<K, V> toTime(final Instant toTime) {
        if (toTime == null) {
            return new MultiVersionedRangeQuery<>(lower, upper, fromTime, Optional.empty());
        }
        return new MultiVersionedRangeQuery<>(lower, upper, fromTime, Optional.of(toTime));
    }
